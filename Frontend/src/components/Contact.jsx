      ...
      <div className="w-full min-h-[100vh] flex flex-col lg:flex-row justify-between py-20">
        ...
        >
          ...
          <div className="p-4 mb-4">
            ...
            <p className="dark:text-white text-sm lg:text-base">3rd Floor, Dubai Tower, Shalimar Link Road. Lahore</p>
          </div>
          <div className="p-4">
            <div className="flex items-center mb-2">
            ...
            <p className="dark:text-white text-sm lg:text-base">faizanshk20@gmail.com</p>
          </div>
          <div className="p-4">
            <div className="flex items-center mb-2">
